...
contract ExerciseC6CApp {
    ...
    constructor
                                (
                                    address dataContract //address of deployed data contract ("ExerciseC6C")
                                ) 
                                public 
    {
        contractOwner = msg.sender;
        exerciseC6C = ExerciseC6C(dataContract); //Initializing state variable
    }
